...
export class PostagensService {
  ...
  getByIdPostagem(id: number): Observable<Postagem>{
    return this.http.get<Postagem>(`http://localhost:80890/postagem/${id}`, this.token)
  }
  ...
  putPostagem(postagem: Postagem): Observable<Postagem>{
    return this.http.put<Postagem>('http://localhost:8090/postagem/put', postagem, this.token)
  }
